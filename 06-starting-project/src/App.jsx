...
function setStoredPlaces(data) {
  localStorage.setItem("selectedPlaces", JSON.stringify(data));
}

const storedPlaceIds = getStoredPlaces();
...
function App() {
  ...
  function handleRemovePlace() {
    ...
    const storedIds = getStoredPlaces();
    setStoredPlaces(storedIds.filter((id) => id !== selectedPlace.current));
  }
